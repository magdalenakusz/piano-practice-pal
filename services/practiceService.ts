...
/**
 * The core algorithm for selecting which scales to practice.
 * It scores each scale based on how long it's been since it was last practiced
 * and the user's confidence level, then picks the highest-scored scales.
